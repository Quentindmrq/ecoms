...
import static om.cgi.formation.jhipster.ecom.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import om.cgi.formation.jhipster.ecom.config.Constants;
import om.cgi.formation.jhipster.ecom.domain.User;
import om.cgi.formation.jhipster.ecom.repository.AuthorityRepository;
...
class AccountResourceIT {
    ...
    void testActivateAccount() throws Exception {
        ...
        assertThat(user.isActivated() != 0).isTrue();
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        assertThat(updatedUser.isActivated() != 0).isTrue();
