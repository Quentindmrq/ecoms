...
class ProductResourceIT {
    ...
    private static final Game UPDATED_GAME = Game.OVERWATCH;

    private static final ProductType DEFAULT_PRODUCT_TYPE = ProductType.GAME_ACCOUNT;
    private static final ProductType UPDATED_PRODUCT_TYPE = ProductType.BOOSTING;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getGame()).isEqualTo(DEFAULT_GAME);
    ...
    @Test
    @Transactional
    void createProductUnAuthentificated() throws Exception {
        int databaseSizeBeforeCreate = productRepository.findAll().size();
        // Create the Product
        restProductMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(product)))
    ...
    @Test
    @Transactional
    void createProductWithExistingIdUnAuthentificated() throws Exception {
        // Create the Product with an existing ID
        product.setId(1L);
    ...
    @WithMockUser(authorities = AuthoritiesConstants.ADMIN)
    @Transactional
    void putNewProductAdmin() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
        ...
        assertThat(testProduct.getGame()).isEqualTo(UPDATED_GAME);
    ...
    @WithMockUser(authorities = AuthoritiesConstants.ADMIN)
    @Transactional
    void putNonExistingProductAdmin() throws Exception {
        int databaseSizeBeforeUpdate = productRepository.findAll().size();
        product.setId(count.incrementAndGet());
    ...
    @WithMockUser(authorities = AuthoritiesConstants.ADMIN)
    @Transactional
    void putWithIdMismatchProductAdmin() throws Exception {
        int databaseSizeBeforeUpdate = productRepository.findAll().size();
        product.setId(count.incrementAndGet());
    ...
    @WithMockUser(authorities = AuthoritiesConstants.ADMIN)
    @Transactional
    void putWithMissingIdPathParamProductAdmin() throws Exception {
        int databaseSizeBeforeUpdate = productRepository.findAll().size();
        product.setId(count.incrementAndGet());
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.game(UPDATED_GAME).productType(UPDATED_PRODUCT_TYPE);
